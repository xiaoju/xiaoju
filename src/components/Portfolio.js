...
function Portfolio() {
  return (
    <div className="cardContainer">
      ...
      <Card
        title="myReads"
        text="A webapp to keep track of the books you read, want to read or are currently reading. Database access through public REST API. First project for React Udacity NanoDegree. "
      ...
      <Card
        title="Juniper lab"
        text="A virtual lab built with Vagrant around Juniper routers, to experiment with network routing protocols."
